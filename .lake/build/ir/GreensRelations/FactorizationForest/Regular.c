...
// Module: GreensRelations.FactorizationForest.Regular
...
LEAN_EXPORT lean_object* initialize_GreensTheorems_GreensRelations_FactorizationForest_Regular(uint8_t builtin) {
lean_object * res;
